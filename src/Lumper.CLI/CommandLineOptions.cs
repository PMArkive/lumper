...
public class CommandLineOptions
{
    ...
    [Option('o',
        ...
        Required = false,
        HelpText =
            "Path to output BSP file. If not provided, and some action modifies the BSP, the input BSP will be overwritten.")]
    ...
    [Option('c',
        ...
        SetName = "compress",
        Required = false,
        HelpText = "Save the output BSP file compressed.")]
